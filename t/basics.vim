...
describe 'vim-textobj-smarty'
  ...
  it 'targets a one-liner block characterwise'
    ...
    " TODO: Expect Do('a',  7, 28) ==# ['v',  7,  7,  7, 36]
    " TODO: Expect Do('a',  7, 31) ==# ['v',  7,  7,  7, 36]
  ...
  it 'targets a multi-line, innermost block characterwise'
    ...
    " TODO: Expect Do('a', 17, 11) ==# ['v', 16,  9, 18, 13]
  ...
  it 'targets a right block from nested blocks'
    " TODO: Expect Do('a', 14,  6) ==# ['v', 12,  5, 27,  9]
    Expect Do('a', 14,  7) ==# ['v', 14,  7, 25, 11]
    " TODO: Expect Do('a', 16,  8) ==# ['v', 14,  7, 25, 11]
    Expect Do('a', 16,  9) ==# ['v', 16,  9, 18, 13]
    " TODO: Expect Do('a', 19,  9) ==# ['v', 14,  7, 25, 11]
    " TODO: Expect Do('a', 26,  7) ==# ['v', 12,  5, 27,  9]
  ...
  it 'targets a {if} block with {else}'
    ...
    " TODO: Expect Do('a', 30,  5) ==# ['v', 29,  5, 35,  9]
    " TODO: Expect Do('a', 31,  5) ==# ['v', 29,  5, 35,  9]
    Expect Do('a', 32,  5) ==# ['v', 29,  5, 35,  9]
    " TODO: Expect Do('a', 33,  5) ==# ['v', 29,  5, 35,  9]
    " TODO: Expect Do('a', 34,  5) ==# ['v', 29,  5, 35,  9]
  ...
  it 'targets a {if} block with {else} and {elseif}'
    ...
    " TODO: Expect Do('a', 38,  5) ==# ['v', 37,  5, 46,  9]
    " TODO: Expect Do('a', 39,  5) ==# ['v', 37,  5, 46,  9]
    Expect Do('a', 40,  5) ==# ['v', 37,  5, 46,  9]
    " TODO: Expect Do('a', 41,  5) ==# ['v', 37,  5, 46,  9]
    " TODO: Expect Do('a', 42,  5) ==# ['v', 37,  5, 46,  9]
    Expect Do('a', 43,  5) ==# ['v', 37,  5, 46,  9]
    " TODO: Expect Do('a', 44,  5) ==# ['v', 37,  5, 46,  9]
    " TODO: Expect Do('a', 45,  5) ==# ['v', 37,  5, 46,  9]
  ...
  it 'targets a {if} block with {else} and {elseif} and a single statement'
    ...
    " TODO: Expect Do('a', 49,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 50,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 51,  5) ==# ['v', 50,  7, 52, 11]
    " TODO: Expect Do('a', 52,  5) ==# ['v', 50,  7, 52, 11]
    " TODO: Expect Do('a', 53,  5) ==# ['v', 48,  5, 64,  9]
    Expect Do('a', 54,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 55,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 56,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 57,  5) ==# ['v', 56,  7, 58, 11]
    " TODO: Expect Do('a', 58,  5) ==# ['v', 56,  7, 58, 11]
    " TODO: Expect Do('a', 59,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 60,  5) ==# ['v', 48,  5, 64,  9]
    " TODO: Expect Do('a', 61,  5) ==# ['v', 60,  7, 62, 11]
    " TODO: Expect Do('a', 62,  5) ==# ['v', 60,  7, 62, 11]
    " TODO: Expect Do('a', 63,  5) ==# ['v', 48,  5, 64,  9]
    Expect Do('a', 64,  5) ==# ['v', 48,  5, 64,  9]

    " TODO: Expect Do('i', 48,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 49,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 50,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 51,  5) ==# ['v', 51,  1, 52,  6]
    " TODO: Expect Do('i', 52,  5) ==# ['v', 51,  1, 52,  6]
    " TODO: Expect Do('i', 53,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 54,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 55,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 56,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 57,  5) ==# ['v', 57,  1, 58,  6]
    " TODO: Expect Do('i', 58,  5) ==# ['v', 57,  1, 58,  6]
    " TODO: Expect Do('i', 59,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 60,  5) ==# ['v', 49,  1, 64,  4]
    " TODO: Expect Do('i', 61,  5) ==# ['v', 61,  1, 62,  6]
    " TODO: Expect Do('i', 62,  5) ==# ['v', 61,  1, 62,  6]
